...
class FilterNet(nn.Module):
    ...
    def forward(self, x):
        ...
        x12 = self.sigmoidEn(self.bn12(self.conv12(x11)))

        #PixelShuffle
        x12_shuffle = self.pixel_shuffle_En(x12)
        ...
        x21d = self.sigmoidDe(self.bn21d(self.conv21d(x22d)))

        #PixelUnshuffle
        x12_unshuffle = self.pixel_shuffle_De(x21d)
        
        # Stage 1d
        x12d = F.relu(self.bn12d(self.conv12d(x12_unshuffle)))

...
class FilterNet(nn.Module):
    def __init__(self,input_nbr=3, gaussian_rate = 1, net_mode_train=True):
        ...
        self.bnUnShuffle = nn.BatchNorm2d(12, momentum= batchNorm_momentum)
    ...
    def forward(self, x):
        ...
        x12_shuffle = self.bnShuffle(x12_shuffle)
        ...
        # x12_unshuffle = self.bnUnShuffle(x12_unshuffle)
        
        # Stage 1d
        x12d = F.relu(self.conv12d(x12_unshuffle))
